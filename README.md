...
- 新着情報：/news
- 新着情報詳細：/news/カテゴリー/タイトル
- 入金確認ログイン画面：/status
- 入金確認表示画面：/status/login

## 共通エフェクト概要

- ヘッダーはスクロールしても固定化させる。https://www.seiban.co.jp/
- メニュー開閉動きはこちら参考。https://www.seiban.co.jp/
- 基本的にテキストコーディングでお願い致します。※文章の差し替えが発生するということとSEOを考量するため。
- 画像はCSSで背景設定するのではなく、imgタグで設置ください。※差し替えを容易にするため
